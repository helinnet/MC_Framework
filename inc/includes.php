<?php
include_once ($realPath . 'Core' . DIRECTORY_SEPARATOR . 'SPS_Config.php');
include_once ($realPath . 'Core' . DIRECTORY_SEPARATOR . 'SPS_ServiceContainer.php');
include_once ($realPath . 'Core' . DIRECTORY_SEPARATOR . 'SPS_Loader.php');
...
$loader->setDir('core', $config->rootPath . 'Core' . DS);
